...
<div align="center">
<img width="125" height="125" src="docs/archive_icon.svg" alt="阅读RR"/>
<br>
阅读RR
<br>
阅读RR 基于 <a href="https://github.com/refgd/legado" target="_blank">refgd/legado</a> 精简维护，仅保留个人使用需要的核心阅读能力，以及桌面端 Web 服务、自动阅读和右侧阅读导航等增强功能。
</div>
...
## 版本说明
- 个人自用维护版本，默认只提供自动构建的 APK Release 历史。
- Android 安装包独立包名为 `io.legado.app.rr`，应用名为“阅读RR”。
#### 下载地址：[GitHub Releases](https://github.com/wio-ki/legado/releases)
